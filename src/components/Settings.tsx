...
const DMIcon = getIDByName('ic_dm')
const ServerIcon = getIDByName('ic_forum_channel')
        ...
        <ScrollView>
            <View style={styles.container}>
                ...
                <View style={styles.title}>
                    <Text style={styles.name}>MarkAllAsRead</Text>
            ...
            <FormSection title="ADD CONFIRMATION">
                ...
                <FormRow
                    ...
                    trailing={
                        <FormSwitch
                            value={settings.getBoolean("server", true)}
                            onValueChange={(value) => {
            ...
            <FormSection title="INFORMATION">
                ...
                <FormRow
                    ...
                    onPress={() => {
                        Linking.openURL("https://github.com/m4fn3/MarkAllAsRead")
                    }}
                />
            </FormSection>
